...
class Scratch3NewBlocks {
    get SWITCH_BOARD_CONNECTION () {
        return [
            {
                text: '1',
                value: SwitchBoard.C1
            },
            {
                text: '2',
                value: SwitchBoard.C2
            },
            {
                text: '3',
                value: SwitchBoard.C3
            },
            {
                text: '4',
                value: SwitchBoard.C4
            }
        ];
    };
    get POWER_MES_MENU () {
    ...
    getInfo () {
        return {
            ...
            blocks: [
                {
                    ...
                    text: formatMessage({
                        ...
                        description: 'command switch board connection'
                    }),
                    arguments: {
                        IN: {
                            type: ArgumentType.STRING,
                            defaultValue: SwitchBoard.C1,
                            menu: 'switch_board_con',
                        },
                        OUT:  {
                            type: ArgumentType.STRING,
                            defaultValue: SwitchBoard.C1,
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description: 'Fossil Energy Current Limit'
                    }),
                    arguments: {
                        FE: {
                            type: ArgumentType.STRING,
                ...
                {
                    opcode: 'switchboardconstate',
                    blockType: BlockType.REPORTER,
                    text: formatMessage({
                        id: 'switchboardconstate',
                        default: 'Connection [IN] to [OUT]',
                        description: 'Switch board connection state'
                    }),
                    arguments: {
                        IN: {
                            type: ArgumentType.STRING,
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description: 'Power Measurement and Channels'
                    }),
                    arguments: {
                        PM: {
                            type: ArgumentType.STRING,
            ...
            menus: {
                ...
                switch_board_con: {
                    acceptReporters: true,
                    items: this.SWITCH_BOARD_CONNECTION,
                },
            },
            translation_map: {
                'it': {
    ...
    powerin (args) {
        if (args.PM === 'POWER') {
            ...
            } else if (args.PCH === 'CH2') {

            } else if (args.PCH === 'CH3') {

            } else if (args.PCH === 'CH4') {

            }
        } else if (args.PM === 'VOLTAGE') {
            if (args.PCH === 'CH1') {
